...
# ──────────────────────────────────────────────────────────────────────────────
OXAPAY_MERCHANT_KEY: str = "sandbox"          # Replace with your OxaPay merchant key
OXAPAY_WEBHOOK_HOST: str = "https://yourdomain.com"  # Publicly reachable base URL (no trailing /)
OXAPAY_WEBHOOK_PORT: int = 8443               # Port to listen on (must be open in firewall / nginx)
